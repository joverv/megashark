...
class MoviesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'releasedate' => ['type' => 'datetime', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'duration' => 1,
            'created' => '2017-11-28 15:51:50',
            'modified' => '2017-11-28 15:51:50',
            'releasedate' => '2017-11-28 15:51:50'
        ],
    ];
}
